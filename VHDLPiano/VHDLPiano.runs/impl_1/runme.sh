...
HD_PWD='C:/Users/Matthew/Development/VHDLPiano/VHDLPiano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piano.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piano.tcl -notrace
